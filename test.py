...
moduledir = os.path.join(path_of_this_file, "chairlift")
...
def setup_translations():
    ...
    for po_file in po_file_path.glob("*.po"):
        ...
        mo_file_path = os.path.join(mo_path, "chairlift.mo")
        subprocess.run(["msgfmt", "-o", mo_file_path, po_file.absolute()])

def setup_gresource():
    resource_file = os.path.join(moduledir, "chairlift.gresource")
