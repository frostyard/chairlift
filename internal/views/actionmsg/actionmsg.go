...
// gated by dry-run, the execution decision) for maintenance-page actions:
// Homebrew Brewfile dumps, Homebrew/Flatpak cleanup, and configured custom
// maintenance scripts.
//
...
// (internal/homebrew, internal/flatpak). Functions whose result gates a
